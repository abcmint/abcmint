...
#ifdef rb___PQC_AES_TAB_C__

#include "rb_core_config.h"

typedef unsigned int ulong32;
static const ulong32 rb_TE0[256] = {
...
#ifndef rb_PELI_TAB
static const ulong32 rb_Te4[256] = {
...
static const ulong32 rb_TD0[256] = {
...
static const ulong32 rb_Td4[256] = {
...
#define rb_Te0(x) rb_TE0[x]
#define rb_Te1(x) rb_RORc(rb_TE0[x], 8)
#define rb_Te2(x) rb_RORc(rb_TE0[x], 16)
#define rb_Te3(x) rb_RORc(rb_TE0[x], 24)

#define rb_Td0(x) rb_TD0[x]
#define rb_Td1(x) rb_RORc(rb_TD0[x], 8)
#define rb_Td2(x) rb_RORc(rb_TD0[x], 16)
#define rb_Td3(x) rb_RORc(rb_TD0[x], 24)

#define rb_Te4_0 0x000000FF & rb_Te4
#define rb_Te4_1 0x0000FF00 & rb_Te4
#define rb_Te4_2 0x00FF0000 & rb_Te4
#define rb_Te4_3 0xFF000000 & rb_Te4

#else

#define rb_Te0(x) rb_TE0[x]
#define rb_Te1(x) rb_TE1[x]
#define rb_Te2(x) rb_TE2[x]
#define rb_Te3(x) rb_TE3[x]

#define rb_Td0(x) rb_TD0[x]
#define rb_Td1(x) rb_TD1[x]
#define rb_Td2(x) rb_TD2[x]
#define rb_Td3(x) rb_TD3[x]

static const ulong32 rb_TE1[256] = {
...
static const ulong32 rb_TE2[256] = {
...
static const ulong32 rb_TE3[256] = {
...
static const ulong32 rb_TD1[256] = {
...
static const ulong32 rb_TD2[256] = {
...
static const ulong32 rb_TD3[256] = {
...
static const ulong32 rb_rcon_00[] = {
